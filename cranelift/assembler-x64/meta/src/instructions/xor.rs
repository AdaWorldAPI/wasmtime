...
pub fn list() -> Vec<Inst> {
    vec![
        ...
        // AVX-512 EVEX-encoded XOR instructions.
        inst("vpxord", fmt("C", [w(xmm1), r(xmm2), r(xmm_m128)]), evex(L128, Full)._66()._0f().w0().op(0xEF).r(), (_64b | compat) & avx512vl & avx512f),
        inst("vpxorq", fmt("C", [w(xmm1), r(xmm2), r(xmm_m128)]), evex(L128, Full)._66()._0f().w1().op(0xEF).r(), (_64b | compat) & avx512vl & avx512f),
    ]
}
