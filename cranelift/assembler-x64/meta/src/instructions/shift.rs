...
pub fn list() -> Vec<Inst> {
    vec![
        ...
        // AVX-512BW word shift-left instructions (EVEX).
        ...
        // AVX-512BW word shift-right-arithmetic instructions (EVEX).
        ...
        // AVX-512BW word shift-right-logical instructions (EVEX).
